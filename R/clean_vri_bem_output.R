...
clean_vri_bem_output <- function(vri_bem) {
  ...
  if (FALSE) {
    ABOVE_ELEV_THOLD<-AGE_CL_STD<-AGE_CL_STS<-BCLCS_LV_1<-BCLCS_LV_5<-BEU_BEC<-BGC_PHASE<-BGC_ZONE<-
      ...
      SDEC_1<-SDEC_2<-SDEC_3<-Shape<-Shape_Area<-SITE_M3A<-SLOPE_MOD<-
...
simplify_vri_bem_output <- function(vri_bem) {
  ...
  if (FALSE) {
    BCLCS_LV_1<-BCLCS_LV_5<-BEU_BEC<-BEUMC_S1<-BGC_PHASE<-BGC_SUBZON<-BGC_VRT<-BGC_ZONE<-
      ...
      PROJ_AGE_1<-Shape<-SITE_M3A<-SOIL_MOISTURE_REGIME_1<-SOIL_NUTRIENT_REGIME<-SPEC_CD_1<-
  ...
  if("DOM_TREE" %in% colnames(vri_bem)){
    vri_bem <- vri_bem |> dplyr::select(PolyID, TEIS_ID, ECO_TYPE, BCLCS_LV_1:BCLCS_LV_5, BGC_ZONE, BGC_SUBZON, BGC_VRT, BGC_PHASE, BGC_label, BEUMC_S1, SDEC_1, ELEV,ELEV_BAND,MEAN_SLOPE,SLOPE_CAT,MEAN_ASP,ASPECT_CAT, SITE_M3A, STAND_A1, STRCT_S1, PROJ_AGE_1, CROWN_ALL_1, DOM_TREE, SPEC_CD_1, SPEC_PCT_1, SPEC_CD_2, SPEC_PCT_2, SPEC_CD_3, SPEC_PCT_3, SPEC_CD_4, SPEC_PCT_4, SPEC_CD_5, SPEC_PCT_5, SPEC_CD_6, SPEC_PCT_6, SOIL_MOISTURE_REGIME_1, SOIL_NUTRIENT_REGIME,SITE_POSITION_MESO, DSTRB_HIST, MRSRD_Y, most_recent_fire, percent_burned, MALAN_WFD_6C_SU_WA, MALAN_GFD_6C_SU_WA, MALAN_WST_6C_SU_WA, MURAR_PEFD_6C_SU_WA, MURAR_PLFD_6C_SU_WA, MURAR_SFD_6C_SU_WA, MURAR_FFD_6C_SU_WA, MURAR_HI_6C_SU_WA, Shape)}

  if(!"DOM_TREE" %in% colnames(vri_bem)){
    vri_bem <- clean_vri_bem_output(vri_bem) |>
      dplyr::select(PolyID, TEIS_ID, ECO_TYPE, BCLCS_LV_1:BCLCS_LV_5, BGC_ZONE, BGC_SUBZON, BGC_VRT, BGC_PHASE, BGC_label, BEUMC_S1, SDEC_1, ELEV,ELEV_BAND,MEAN_SLOPE,SLOPE_CAT,MEAN_ASP,ASPECT_CAT, SITE_M3A, STAND_A1, STRCT_S1, PROJ_AGE_1, CROWN_ALL_1, DOM_TREE, SPEC_CD_1, SPEC_PCT_1, SPEC_CD_2, SPEC_PCT_2, SPEC_CD_3, SPEC_PCT_3, SPEC_CD_4, SPEC_PCT_4, SPEC_CD_5, SPEC_PCT_5, SPEC_CD_6, SPEC_PCT_6, SOIL_MOISTURE_REGIME_1, SOIL_NUTRIENT_REGIME, SITE_POSITION_MESO, DSTRB_HIST, MRSRD_Y,MALAN_WFD_6C_SU_WA, MALAN_WFD_6C_CAP_WA, MALAN_GFD_6C_SU_WA,MALAN_GFD_6C_CAP_WA, MALAN_WST_6C_SU_WA, MALAN_WST_6C_CAP_WA, MURAR_PEFD_6C_SU_WA, MURAR_PEFD_6C_CAP_WA,MURAR_PLFD_6C_SU_WA, MURAR_PLFD_6C_CAP_WA, MURAR_SFD_6C_SU_WA, MURAR_SFD_6C_CAP_WA, MURAR_FFD_6C_SU_WA, MURAR_FFD_6C_CAP_WA, MURAR_HI_6C_SU_WA,MURAR_HI_6C_CAP_WA, Shape)}
